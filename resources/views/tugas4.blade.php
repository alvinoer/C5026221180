...
function validateForm() {
  ...
  // lakukan per jenis validasi, agar user tahu salahnya dimana
  if (x.value == "") { // isian kosong artinya text boxnya tidak diisi apa apa/kosong
  ...
  if (nrp.value == "") { // isian kosong artinya text boxnya tidak diisi apa apa/kosong
...
// console.log(nrp.value.length); buat cek bener apa engga
