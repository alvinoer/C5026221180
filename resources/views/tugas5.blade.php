<html>
    <head>
        <title>
            @BINUSMalang | Linktree
        </title>
        <link rel="icon" type="image/png" href="https://linktr.ee/_next/static/logo-assets/favicon.png">
        <link rel="stylesheet" href={{asset('5026221180.css')}}>


    </head>

    <body>
        <div class="vino_header">
            <div class="vino_mb-16">
                <img src="https://ugc.production.linktr.ee/nPmzTMcoQOOGq0SW0f4Y_DegXgGZ393y587oE?io=true&size=avatar-v1" class="vino_border">
            </div>

            <div>
                <h1 class="vino_h1">@BINUSMalang</h1>
            </div>

            <div class="vino_divh2">
                <h2 class="vino_h2"> Universitas Bina Nusantara Kampus Kota Malang </h2>
            </div>
        </div>
        ...
        <div class="vino_opsi">
            ...
            <div>
                <h3 class="vino_h3">Student Services Center (SSC)</h3>
            </div>

            <a href="https://binus.zoom.us/j/93395435341"
            class="vino_bar" target="_blank"
            >SSC Zoom | Mon to Fri at 09.00-16.00</a>
            <a href="https://link.binus.org/SSCMlg"
            class="vino_bar" target="_blank"
            >SSC Email</a>
            <a href="http://bit.ly/wa-me-087801724687"
            class="vino_bar" target="_blank"
            >WhatsApp (for Students)</a>
            <a href="https://outlook.office365.com/owa/calendar/SSCBINUSMalang@binusianorg.onmicrosoft.com/bookings/"
            class="vino_bar" target="_blank"
            >SSC Reservasi Layanan Onsite Terbatas</a>
            <a href="https://wa.me/+6281316969669"
            class="vino_bar" target="_blank"
            >SSC WhatsApp (for Parents)</a>
            <a href="https://bit.ly/permohonansscmlg"
            class="vino_bar" target="_blank"
            >SSC Services - Form Request (Permohonan)</a>
            <a href="https://bit.ly/pdm-mlg"
            class="vino_bar" target="_blank"
            >SSC Services - Student Data Change Request (Name/Place of birth/Date of birth/Gender)</a>

            <div class="vino_judul">
                <h3 class="vino_h3">Lecturer Services Center (LSC)</h3>
            </div>

            <a href="https://binus.zoom.us/j/94365687929"
            class="vino_bar" target="_blank"
            >LSC Zoom | Mon to Fri at 09.00-16.00, Sat at 09.00-14.00</a>
            <a href="http://link.binus.org/emailLSCMlg"
            class="vino_bar" target="_blank"
            >LSC Email</a>
            <a href="http://wa.me/6282245678169"
            class="vino_bar" target="_blank"
            >LSC Whatsapp</a>
        ...
        <div>
            <a href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_content=BINUSMalang"
            class="vino_linktree"></a>
        </div>

        <div class="vino_linktree1">
            <div class="vino_linktree2">
                <a href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_content=BINUSMalang" class="vino_displaylinktree">
                    <svg height="100%" viewBox="0 0 80 17" style="display: block;width:auto" fill="none" xmlns="http://www.w3.org/2000/svg">
